...
module.exports = class ProjectTemplateTasks extends Abstract {
    ...
    /**
    * @api {post} /improvement-projects/api/v1/project/templateTasks/bulkCreate/:projectTemplateId Bulk create project template tasks.
    * @apiVersion 1.0.0
    ...
    * @apiSampleRequest /improvement-projects/api/v1/project/templateTasks/bulkCreate/5f2adc57eb351a5a9c68f403
    * @apiUse successBody
    * @apiUse errorBody
    */
    ...
    async bulkCreate(req) {
     ...
     /**
    * @api {post} /improvement-projects/api/v1/project/templateTasks/bulkUpdate/:projectTemplateId Bulk update project template tasks.
    * @apiVersion 1.0.0
    * @apiName Bulk update projects templates tasks
    * @apiGroup Project Template Tasks
    * @apiParam {File} projectTemplateTasks Mandatory project template tasks file of type CSV.
    * @apiSampleRequest /improvement-projects/api/v1/project/templateTasks/bulkUpdate/5f2adc57eb351a5a9c68f403
    * @apiUse successBody
    * @apiUse errorBody
    */
