...
module.exports = class ProjectTemplates extends Abstract {
    ...
    /**
    * @api {post} /improvement-projects/api/v1/project/templates/bulkCreate Bulk Create projects templates.
    * @apiVersion 1.0.0
    ...
    * @apiSampleRequest /improvement-projects/api/v1/project/templates/bulkCreate
    * @apiUse successBody
    * @apiUse errorBody
    */
    ...
    /**
    * @api {post} /improvement-projects/api/v1/project/templates/bulkUpdate Bulk Update projects templates.
    * @apiVersion 1.0.0
    * @apiName Bulk Update projects templates
    * @apiGroup Project Templates
    * @apiParam {File} projectTemplates Mandatory project templates file of type CSV.
    * @apiSampleRequest /improvement-projects/api/v1/project/templates/bulkUpdate
    * @apiUse successBody
    * @apiUse errorBody
    */
    ...
    async bulkUpdate(req) {
     ...
     /**
    * @api {post} /improvement-projects/api/v1/project/templates/importFromTemplates/:projectTemplateExternalId Import templates from existsing project templates.
    * @apiVersion 1.0.0
    * @apiName Import templates from existsing project templates.
    * @apiGroup Project Templates
    * @apiSampleRequest /improvement-projects/api/v1/project/templates/importFromTemplates/template-1
